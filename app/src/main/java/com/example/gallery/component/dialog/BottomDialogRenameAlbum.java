...
public class BottomDialogRenameAlbum extends BottomSheetDialogFragment {
    public static interface OnRenameDialogListener {
        void onRenameAlbum(String albumName);
    }
    private OnRenameDialogListener listener;
    public BottomDialogRenameAlbum(OnRenameDialogListener listener) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_bottom_dialog_rename_album, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        createAlbumBtn.setOnClickListener(v -> {
            ...
            if (albumNameStr.isEmpty()) {
                ...
                listener.onRenameAlbum(albumNameStr);
                dismiss();
            }
        });
